...
export type MasonryProps = {
	 ...
	 *
	 * The value can ba a number (e.g. `10` for `10px`) or a string value (e.g. `10px` or `2rem`).
	 *
	 * @example
	 * ```vue
	 * <!-- Static gutter width -->
	...
	/**
	 * Set to `true`, if the children are wrapped in a single node.
	 * @default false
	 */
	childItemWrapper?: boolean;
	/**
